module.exports = {
	...
	goPage(e) {
		...
		page && obj[openType]()
		console.log('123654',page,openType)
	...
	GetSessionKey(dataObj) {
		// console.log('data2',this.get('/KorjoApi/GetSessionKey', dataObj))
	  return this.get('/KorjoApi/GetSessionKey', dataObj)
	},
